...
from Ekankthbot.modules.helper_funcs.chat_status import bot_admin, bot_can_delete

from Ekankthbot.modules.helper_funcs.decorators import Ekankth, Ekankthmsg
from ..modules.helper_funcs.anonymous import user_admin, AdminPerms
import Ekankthbot.modules.sql.antilinkedchannel_sql as sql


@Ekankth(command="antilinkedchan", group=112)
@bot_can_delete
...
@Ekankthmsg(Filters.is_automatic_forward, group=111)
...
@Ekankth(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Ekankthmsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
