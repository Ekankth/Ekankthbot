...
from .helper_funcs.decorators import Ekankth, Ekankthcallback
...
@Ekankth(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@Ekankthcallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Ekankthcallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@Ekankthcallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@Ekankth(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
