...
from Ekankthbot.modules.sql.approve_sql import is_approved
import Ekankthbot.modules.sql.blacklist_sql as sql
from Ekankthbot import log, dispatcher
from Ekankthbot.modules.helper_funcs.chat_status import user_admin as u_admin, user_not_admin
from Ekankthbot.modules.helper_funcs.extraction import extract_text
from Ekankthbot.modules.helper_funcs.misc import split_message
from Ekankthbot.modules.log_channel import loggable
from Ekankthbot.modules.warns import warn
from Ekankthbot.modules.helper_funcs.string_handling import extract_time
from Ekankthbot.modules.connection import connected
from Ekankthbot.modules.helper_funcs.decorators import Ekankth, Ekankthmsg
from Ekankthbot.modules.helper_funcs.alternate import send_message, typing_action

from ..modules.helper_funcs.anonymous import user_admin, AdminPerms

BLACKLIST_GROUP = -3

@Ekankth(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@Ekankth(command="addblacklist", pass_args=True)
...
@Ekankth(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@Ekankth(command="blacklistmode", pass_args=True)
@loggable
...
@Ekankthmsg(((Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.chat_type.groups), group=BLACKLIST_GROUP)
@user_not_admin
