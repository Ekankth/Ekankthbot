...
from Ekankthbot import dispatcher, log, SUDO_USERS
from Ekankthbot.modules.helper_funcs.extraction import extract_text
from Ekankthbot.modules.helper_funcs.filters import CustomFilters
from Ekankthbot.modules.helper_funcs.misc import build_keyboard_parser
from Ekankthbot.modules.helper_funcs.msg_types import get_filter_type
from Ekankthbot.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from Ekankthbot.modules.sql import cust_filters_sql as sql
...
from Ekankthbot.modules.helper_funcs.decorators import Ekankth, Ekankthmsg, Ekankthcallback
...
@typing_action
@Ekankth(command='filters', admin_ok=True)
...
@Ekankth(command='filter', run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@Ekankth(command='stop', run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@Ekankthmsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@Ekankth(command="removeallfilters", filters=Filters.chat_type.groups)
...
@Ekankthcallback(pattern=r"filters_.*")
