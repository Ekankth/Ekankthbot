...
import Ekankthbot.modules.sql.approve_sql as sql
from Ekankthbot import SUDO_USERS
from Ekankthbot.modules.helper_funcs.chat_status import user_admin as u_admin
...
@Ekankth(command='approve', filters=Filters.chat_type.groups)
@loggable
...
@Ekankth(command='unapprove', filters=Filters.chat_type.groups)
@loggable
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@Ekankth(command='approved', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@Ekankth(command='approval', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@Ekankth(command='unapproveall', filters=Filters.chat_type.groups)
...
@Ekankthcallback(pattern=r"unapproveall_.*")
