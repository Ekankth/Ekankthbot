...
from Ekankthbot.modules.helper_funcs.extraction import (
    extract_user,
    extract_unt_fedban,
    extract_user_fban,
)
from Ekankthbot.modules.helper_funcs.string_handling import markdown_parser

import Ekankthbot.modules.sql.feds_sql as sql

from Ekankthbot.modules.helper_funcs.alternate import (
    send_message,
    typing_action,
    send_action,
)
from Ekankthbot.modules.helper_funcs.decorators import Ekankth, Ekankthcallback
...
@typing_action
@Ekankth(command='delfed', pass_args=True)
...
@typing_action
@Ekankth(command='chatfed', pass_args=True)
...
@typing_action
@Ekankth(command='joinfed', pass_args=True)
...
@typing_action
@Ekankth(command='fpromote', pass_args=True)
...
@typing_action
@Ekankth(command='fdemote', pass_args=True)
...
@typing_action
@Ekankth(command='fedinfo', pass_args=True)
...
@typing_action
@Ekankth(command='fedadmins', pass_args=True)
...
@typing_action
@Ekankth(command=['fban', 'fedban'], pass_args=True)
...
@typing_action
@Ekankth(command=['unfban', 'rmfedban'], pass_args=True)
...
@typing_action
@Ekankth(command='frules', pass_args=True)
...
@typing_action
@Ekankth(command='fbroadcast', pass_args=True)
...
@Ekankth(command='fbanlist', pass_args=True, pass_chat_data=True)
...
@typing_action
@Ekankth(command='fednotif', pass_args=True)
...
@typing_action
@Ekankth(command='fedchats', pass_args=True)
...
@typing_action
@Ekankth(command='importfbans', pass_args=True, pass_chat_data=True)
...
@Ekankthcallback(pattern=r"rmfed_")
...
@typing_action
@Ekankth(command='fbanstat', pass_args=True)
...
@typing_action
@Ekankth(command='setfedlog', pass_args=True)
...
@typing_action
@Ekankth(command='unsetfedlog', pass_args=True)
...
@typing_action
@Ekankth(command='unsubfed', pass_args=True)
...
@typing_action
@Ekankth(command='fedsubs', pass_args=True)
...
@typing_action
@Ekankth(command='myfeds', pass_args=True)
...
@Ekankthcallback(pattern=r"fed_help_")
