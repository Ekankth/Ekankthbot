...
from Ekankthbot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Ekankthbot import GBAN_LOGS, log, dispatcher
    from Ekankthbot.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
    from Ekankthbot.modules.sql import log_channel_sql as sql
...
@Ekankthcallback(pattern=r"log_tog_.*")
