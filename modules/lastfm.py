...
from Ekankthbot import LASTFM_API_KEY
from Ekankthbot.modules.helper_funcs.decorators import Ekankth
import Ekankthbot.modules.sql.last_fm_sql as sql

@Ekankth(command='setuser')
