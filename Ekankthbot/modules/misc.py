...
from Ekankthbot.__main__ import STATS, USER_INFO, TOKEN
from Ekankthbot.modules.sql import SESSION
from Ekankthbot.modules.helper_funcs.chat_status import user_admin, sudo_plus
from Ekankthbot.modules.helper_funcs.extraction import extract_user
import Ekankthbot.modules.sql.users_sql as sql
...
@Ekankth(command='id', pass_args=True)
...
@Ekankth(command='info', pass_args=True)
...
@Ekankth(command='echo', pass_args=True, filters=Filters.chat_type.groups)
@user_admin
...
@Ekankth(command='markdownhelp', filters=Filters.chat_type.private)
...
stats_str = '''
'''
@Ekankth(command='stats', can_disable=False)
@sudo_plus
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/Ekankth) | [⍚ GitLab](https://gitlab.com/Ekankth)\n\n" +
            "╘══「 by [Ekankth](https://t.me/ekankth) 」\n",
...
@Ekankthcallback(pattern=r'^pingCB')
