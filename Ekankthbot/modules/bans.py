...
from Ekankthbot.modules.helper_funcs.extraction import extract_user_and_text
from Ekankthbot.modules.helper_funcs.string_handling import extract_time
from Ekankthbot.modules.log_channel import loggable, gloggable
from Ekankthbot.modules.helper_funcs.decorators import Ekankth

from ..modules.helper_funcs.anonymous import user_admin, AdminPerms


@Ekankth(command='ban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
@Ekankth(command='tban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Ekankth(command='kick', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Ekankth(command='kickme', pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@Ekankth(command='unban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@Ekankth(command='selfunban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
