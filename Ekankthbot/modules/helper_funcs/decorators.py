from Ekankthbot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from telegram.ext import CommandHandler, MessageHandler, CallbackQueryHandler, InlineQueryHandler
from telegram.ext.filters import BaseFilter
from Ekankthbot import dispatcher as d, log
...
Ekankth = AnieTelegramHandler(d).command
Ekankthmsg = AnieTelegramHandler(d).message
Ekankthcallback = AnieTelegramHandler(d).callbackquery
Ekankthinline = AnieTelegramHandler(d).inlinequery
