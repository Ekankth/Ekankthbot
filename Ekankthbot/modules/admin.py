...
@Ekankth(command="promote", can_disable=False)
@connection_status
@bot_admin
@can_promote
...
@Ekankth(command="demote", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
"""
@Ekankth(command="admincache", can_disable=False)
@u_admin
...
@Ekankth(command="title", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
@Ekankth(command="pin", can_disable=False)
@bot_admin
@can_pin
...
@Ekankth(command="unpin", can_disable=False)
@bot_admin
@can_pin
@user_admin(AdminPerms.CAN_PIN_MESSAGES)
@loggable
...
@Ekankth(command="invitelink", can_disable=False)
@bot_admin
...
@Ekankth(command=["admin", "admins", "staff"])
