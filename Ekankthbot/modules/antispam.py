...
from Ekankthbot.modules.sql.users_sql import get_user_com_chats
import Ekankthbot.modules.sql.antispam_sql as sql
...
from Ekankthbot.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Ekankthbot.modules.helper_funcs.misc import send_to_list
...
@Ekankthmsg((Filters.all & Filters.chat_type.groups), can_disable=False, group=GBAN_ENFORCE_GROUP)
