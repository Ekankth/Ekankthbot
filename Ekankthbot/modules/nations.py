...
from Ekankthbot.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from Ekankthbot.modules.helper_funcs.extraction import extract_user
from Ekankthbot.modules.log_channel import gloggable
from Ekankthbot.modules.sql import nation_sql as sql
from Ekankthbot.modules.helper_funcs.decorators import Ekankth
...
@Ekankth(command='removewhitelist')
@sudo_plus
@gloggable
...
@Ekankth(command='removesardegna')
@sudo_plus
@gloggable
...
nations = """ Ekankth has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Ekankth is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Kigyō.
\n*Sakuras* - Have access go globally ban users across Ekankth.
...
@Ekankth(command=["supportlist", "sakuras"])
@whitelist_plus
...
@Ekankth(command=["sudolist", "royals"])
@whitelist_plus
