...
import Ekankthbot.modules.sql.notes_sql as sql
from Ekankthbot import log, dispatcher, SUDO_USERS
from Ekankthbot.modules.helper_funcs.chat_status import connection_status
from Ekankthbot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Ekankthbot.modules.helper_funcs.msg_types import get_note_type
from Ekankthbot.modules.helper_funcs.handlers import MessageHandlerChecker
from Ekankthbot.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
...
@Ekankthmsg((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@Ekankthmsg((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
@Ekankth(command='removeallnotes')
...
@Ekankthcallback(pattern=r"notes_.*")
