...
from Ekankthbot import log, SUDO_USERS, SARDEGNA_USERS, WHITELIST_USERS
...
from Ekankthbot.modules.sql import reporting_sql as sql
...
import Ekankthbot.modules.sql.log_channel_sql as logsql
...
@Ekankth(command='report', filters=Filters.chat_type.groups, group=REPORT_GROUP)
@Ekankthmsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@Ekankthcallback(pattern=r"report_")
