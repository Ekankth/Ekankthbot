...
from Ekankthbot.modules.helper_funcs.misc import article
from Ekankthbot.modules.helper_funcs.decorators import Ekankthinline
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Ekankth (@{context.bot.username})
    Maintained by [Ekankth](t.me/Ekankth)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Support",
                    url=f"https://t.me/EkankthSupports",
                ),
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/EkankthBots",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitLab",
                    url=f"https://www.gitlab.com/Ekankth",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/Ekankth",
                ),
            ],
        ])
...
def media_query(query: str, update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        for data in res:
            ...
            bannerimg = data.get("bannerImage") or "https://te.legra.ph/file/440f8721f9c678286c2ce.jpg"
            try:
            ...
            genres = ", ".join(genres)
            img = f"https://img.anili.st/media/{data['id']}" or "https://te.legra.ph/file/440f8721f9c678286c2ce.jpg"
