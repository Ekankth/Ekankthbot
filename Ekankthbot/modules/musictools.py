...
fotoplay = "https://te.legra.ph/file/440f8721f9c678286c2ce.jpg"
ngantri = "https://te.legra.ph/file/440f8721f9c678286c2ce.jpg"
from Ekankthbot import call_py, telethn as Ekankth, client as Client
owner = "1669178360"
from Ekankthbot.helpers.yt_dlp import bash
from Ekankthbot.helpers.chattitle import CHAT_TITLE
from Ekankthbot.helpers.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from Ekankthbot.events import register
from Ekankthbot.helpers.thumbnail import gen_thumb
from Ekankthbot.helpers.joiner import AssistantAdd
...
@Ekankth.on(events.NewMessage(pattern="^[?!/.]vplay"))
@AssistantAdd
...
#playlist
@Ekankth.on(events.NewMessage(pattern="^[?!/.]playlist"))
@is_admin
...
#leavevc
@Ekankth.on(events.NewMessage(pattern="^[?!/.]leavevc"))
@is_admin
...
@Ekankth.on(events.NewMessage(pattern="^[?!/.]skip"))
@is_admin
...
@Ekankth.on(events.NewMessage(pattern="^[?!/.]pause"))
@is_admin
...
@Ekankth.on(events.NewMessage(pattern="^[?!/.]resume"))
@is_admin
