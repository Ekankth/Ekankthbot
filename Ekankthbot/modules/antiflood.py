...
from Ekankthbot import SARDEGNA_USERS, WHITELIST_USERS, dispatcher
from Ekankthbot.modules.sql.approve_sql import is_approved
from Ekankthbot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    connection_status,
    is_user_admin,
...
from Ekankthbot.modules.sql import antiflood_sql as sql
...
from Ekankthbot import dispatcher
...
from Ekankthbot.modules.helper_funcs.alternate import send_message
...
@Ekankthmsg((Filters.all & ~Filters.status_update & Filters.chat_type.groups), group=FLOOD_GROUP)
@connection_status
@loggable
...
@user_admin_no_reply
@bot_admin
@Ekankthcallback(pattern=r"unmute_flooder")
...
@Ekankth(command='setflood', pass_args=True, filters=Filters.chat_type.groups)
@connection_status
...
@Ekankth(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@Ekankth(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
