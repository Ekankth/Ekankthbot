...
import Ekankthbot.modules.sql.locks_sql as sql
from Ekankthbot import dispatcher, log
...
@Ekankth(command='lock', pass_args=True)
...
@Ekankth(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@Ekankthmsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
