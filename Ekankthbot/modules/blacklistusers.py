...
import Ekankthbot.modules.sql.blacklistusers_sql as sql
...
from Ekankthbot.modules.helper_funcs.chat_status import dev_plus
...
@Ekankth(command=['ignore', 'addblocklist'], pass_args=True)
@dev_plus
@gloggable
...
@Ekankth(command='notice', pass_args=True)
@dev_plus
@gloggable
...
@Ekankth(command='ignoredlist', pass_args=True)
@dev_plus
