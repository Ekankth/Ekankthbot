...
import Ekankthbot.modules.sql.userinfo_sql as sql
from Ekankthbot import SUDO_USERS, DEV_USERS
...
@Ekankth(command='me', pass_args=True)
...
@Ekankth(command='bio', pass_args=True)
